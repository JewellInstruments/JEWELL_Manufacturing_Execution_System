...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        sizePolicy.setHeightForWidth(self.SBTButton.sizePolicy().hasHeightForWidth())
        self.SBTButton.setSizePolicy(sizePolicy)
        self.SBTButton.setMinimumSize(QSize(0, 24))
        ...
        sizePolicy4.setHeightForWidth(self.ReadyToggle.sizePolicy().hasHeightForWidth())
        self.ReadyToggle.setSizePolicy(sizePolicy4)
