...
def solve_least_squares(
    ...
    """solve linear regression equations for n-th order polynomial where n = order.
    ...
    try:
        ...
        r2, sig_y = statistical_methods.r_score(x_data, y_data, coefficients)
...
def display_matrix(matrix: list, specs: get_specs.mems_specs) -> None:
